...
flags.DEFINE_string('token_count_file', './tmp/word_vocab.txt-00000-of-00001', 'Beam pipeline output file path.')
flags.DEFINE_integer('min_word_frequency', 0, 'Minimum word frequency.')
flags.DEFINE_string('output_word_vocab_file', './tmp_widget/word_vocab_from_create_vocab.txt',
